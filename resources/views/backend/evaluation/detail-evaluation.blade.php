    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Hasil Data Penilaian Karyawan</div>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            @forelse ($evaluates as $evaluate)
                                <tr>
                                    ...
                                    @if (Auth::user()->role_id == 1)
                                        <td>
                                            <a href="" class="btn btn-success btn-sm" id="editEvaluate"
                                                title="Edit Data" data-toggle="modal" data-target="#evaluateModal"
                                                data-attr="{{ url('evaluation/detail/edit', $evaluate->subcriteria_code) }}">
