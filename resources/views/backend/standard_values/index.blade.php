...
<div class="row">
    ...
    <table id="datatable" class="align-middle mb-0 table table-borderless table-striped table-hover">        <thead>
            <tr>
                <th>No</th>
                <th>Type</th>
                <th>Range</th>
        ...
        <tbody>
            @foreach ($values as $index => $value)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('standard_values.edit', $value->id) }}" class="btn btn-warning"> <i class="fas fa-edit"></i></a>
