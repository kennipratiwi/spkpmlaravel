        ...
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                    <div class="alert alert-success">
                       Info : Total bobot saat ini adalah: {{ $currentWeight }} dari 100 (maksimal)
                    </div>
                    <div class="alert alert-warning">
                        Perhatian : Harap hapus data penilaian terlebih dahulu sebelum menambahkan sub_kriteria baru
                    </div>
                        ...
                        <tbody>
                            @forelse ($subcriteria as $data)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-warning btn-sm" data-toggle="tooltip" title="Edit" href="{{ route('sub-criteria.edit', $data->id) }}">
